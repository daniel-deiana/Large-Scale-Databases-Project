        ...
        $.ajax({
                ...
                success: function(data) {
                    ...
                    if(result == null)
                        ...
                        for(fig in result){
                            if(fig<5){
                                let html = '<div style= "margin:10px; width: 200px; display: flex; flex-direction: column; align-items: center; justify-content: center;"><img referrerpolicy="no-referrer" src='+result[fig].image_url+'alt="" style="width:130px; height:180px;"><h2 style="font-size: 15px; color: grey;">' + result[fig].name +'</h2><h2 style="font-size: 15px;">'+ result[fig].anime +'</h2></div>'
                                $("#first5").append(html)
                            }
                            else{
                                let html = '<div style= "margin:10px; width: 200px; display: flex; flex-direction: column; align-items: center; justify-content: center;"><img referrerpolicy="no-referrer" src='+result[fig].image_url+' alt="" style="width:130px; height:170px;"><h2 style="font-size: 15px; color: grey;">' + result[fig].name +'</h2><h2 style="font-size: 15px;">'+ result[fig].anime +'</h2></div>'
                                $("#second5").append(html)
                            }
                        }

        ...
        success: function(data) {
            ...
            if(!result) {
                ...
                let html = '<img style="height:200px; width: 160px;"referrerpolicy="no-referrer" src='+result.image_url+' alt="">' +
                    ...
                    '<a class="btn-get-started scrollto" style=" text-align: center; margin: auto; cursor: pointer;" onclick="addToTop10(this.offsetParent.childNodes[1].textContent)">Add to Top10</a><br>' +
                    '<a class="btn-get-started scrollto" style=" text-align: center; margin: auto; cursor: pointer;" onclick="removeFromTop10(this.offsetParent.childNodes[1].textContent)">Remove from Top10</a>';
